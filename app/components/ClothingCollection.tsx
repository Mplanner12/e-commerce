...
const ClothingCollection = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center w-full px-[2rem] mb-[5.5rem] md:mb-[16rem] h-fit md:h-[20rem] gap-x-2 gap-y-10">
      <div className="h-[33.5rem] p-0 px-[1.5rem] lg:px-[2rem] rounded-3xl bg-blue-gray-900 w-full lg:w-full">
        <Image
          ...
          height={80}
        />
        <button className="backdrop-blur py-3 px-4 w-full mx-auto md:w-[24rem] lg:w-full flex justify-between text-gray-400 text-md md:text-2xl rounded-2xl bg-[gray]/20 relative -top-[5rem] md:-top-24">
          MENS CLOTHING
